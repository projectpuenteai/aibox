...
public static class Translations
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _table = new()
    {
        [LangEs] = new()
        {
            ...
            ["hotspotInactive"] = "HOTSPOT NO ACTIVO",
            ["pillOff"]        = "APAGADO",
            ["pillStarting"]   = "INICIANDO...",
            ["pillReady"]      = "ENCENDIDO",
            ["pillStopping"]   = "DETENIENDO...",
            ["footerReady"]    = "Listo — {0}",
            ["footerReadyNoHotspot"] = "Sistema activo — hotspot no activo",
        ...
        [LangEn] = new()
        {
            ...
            ["hotspotInactive"] = "HOTSPOT NOT ACTIVE",
            ["pillOff"]        = "OFF",
            ["pillStarting"]   = "STARTING...",
            ["pillReady"]      = "ON",
            ["pillStopping"]   = "STOPPING...",
            ["footerReady"]    = "Ready — {0}",
            ["footerReadyNoHotspot"] = "System running — hotspot offline",
